<?php
// $Id: sites/all/themes/express/node-webform.tpl.php 1.9 2010/02/18 15:03:05EST Linda M. Williams (WILLIAMSLM) Production  $
?>
<div id="node-<?php print $node->nid; ?>" class="node<?php if ($sticky) { print ' sticky'; } ?><?php if (!$status) { print ' node-unpublished'; } ?>">
    ...
    <div class="content clear-block">
        ...
        <?php if ($node->field_terms[0]['value'] == "Yes"){ ?>
            <div class="terms-use">By Submitting this form, I understand and agree to the Rules for this promotion and to the <a href="#" onclick="window.open('<?php print $expresstermsurl; ?>', 'Rules', 'toolbar=no,location=no,status=no,menubar=no,scrollbars=yes,width=460,height=500');return false;">TERMS OF USE</a> for this website.</div>
               <?php } ?>
            <div class="terms-use">Read our <a href="#" onclick="window.open('<?php print $expressprivacyurl; ?>', 'Rules', 'toolbar=no,location=no,status=no,menubar=no,scrollbars=yes,width=460,height=500');return false;">Privacy Policy</a> to learn how we use your personal information.</div>
            <?php if ($node->field_return_policy[0]['value'] == "Yes"){ ?>
            <div class="terms-use">Read our <a href="#" onclick="window.open('<?php print $expressreturnpolicyurl; ?>', 'Rules', 'toolbar=no,location=no,status=no,menubar=no,scrollbars=yes,width=460,height=500');return false;">Return Policy</a> to learn about ticket purchase returns.</div>
               <?php } ?>
